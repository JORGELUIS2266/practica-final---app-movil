// src/pantallas/FormularioAlumnoPantalla.js
        ...
        <View style={styles.card}>
          ...
          <View style={styles.inputPicker}>
            ...
            >
              ...
              {["ISC","Administración","Industrial","Mecatrónica","Civil","Arquitectura","Gestión"].map((c, index) => (
...
const styles = StyleSheet.create({
  ...
  inputPicker: { borderWidth: 1, borderColor: "#00F0FF", borderRadius: 8, backgroundColor: "#10153D", marginBottom: 10, overflow: "hidden" },
